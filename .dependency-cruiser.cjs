...
module.exports = {
    forbidden: [
        ...
        },
        {
            ...
            comment:
                "Modules should have as few dependencies on other modules as possible " +
                " which is not critical and can't be totaly avoided but generally should be.",
            severity: 'warn',
            from: {
                path: "^src/([^/]+)/.+",
                pathNot: "^src/(pages)/.+",
...
// generated: dependency-cruiser@16.10.4 on 2025-07-04T01:40:49.648Z
