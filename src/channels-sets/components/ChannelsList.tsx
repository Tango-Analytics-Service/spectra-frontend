...
import { CheckCircle, AlertCircle, Trash2, Calendar, Eye, Users, Loader2, Edit, MoreHorizontal, Check, Search, } from "lucide-react";
...
export default function ChannelsList({ channels, setId, canManageChannels = false }: ChannelsListProps) {
    const removeChannelsFromSet = useRemoveChannelsFromSet(setId);
