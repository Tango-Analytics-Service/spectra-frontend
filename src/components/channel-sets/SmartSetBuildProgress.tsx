// src/components/channel-sets/SmartSetBuildProgress.tsx
...
import {
  ChannelSet,
  SmartSetBuildStatus,
  SmartSetBuildProgress as BuildProgressType,
...
const SmartSetBuildProgress: React.FC<SmartSetBuildProgressProps> = ({
  channelSet,
  onRefresh,
  className,
}) => {
  const { cancelSmartSetBuild, refreshSmartSetStatus } = useChannelSets();
...
export default SmartSetBuildProgress;
