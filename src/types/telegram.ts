...
interface WebApp {
     ...
     * In any case, the user will still be able to minimize and close the
    ...
    /**
     * True, if the Mini App’s orientation is currently locked. False, if
     * orientation changes freely based on the device’s rotation.
     */
