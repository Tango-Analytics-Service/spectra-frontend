import { authenticateWithTelegram, isTokenValid, saveToken } from "@/services/authService";
import { getUserFromTelegram, isTelegramWebApp, notifyAppReady } from "@/utils/telegramWebApp";
